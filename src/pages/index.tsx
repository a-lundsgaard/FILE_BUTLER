    ...
    <div className="pb-20 ">
      <div className="text-center inline " >
        <section className="text-white pb-20 lg:pb-40 pt-8 sm:pt-20 px-10 bg-gradient-to-b from-indigo-800 to-indigo-500 " >
          <h1 className='font-semibold text-3xl sm:text-4xl md:text-5xl' > Every tool you need to work with files.</h1>
          <h2 className='text-sm sm:text-xl mt-2 ' >A website to merge PDF files and extract text from images. It is a 100% free tool to use.</h2>
        </section>
      </div>
